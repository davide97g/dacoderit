...
export default function ProjectsPage() {
  const projects = [
    ...
    },
    {
      ...
      description: "A collaborative project for an e-commerce dashboard with analytics",
  ...
  return (
    <div className="container max-w-4xl px-4 py-12">
      <div className="mb-12">
        ...
        <p className="text-xl text-muted-foreground">A showcase of open source and collaborative projects</p>
      </div>
          ...
          <Card key={index}>
            <CardHeader>
              <div className="flex justify-between items-start">
                ...
                <Badge variant={project.type === "Open Source" ? "default" : "secondary"}>{project.type}</Badge>
              </div>
            </CardHeader>
            <CardContent>
